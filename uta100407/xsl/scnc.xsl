...
<xsl:template match="uta:scenes">
  ...
  <xsl:text>&#010;</xsl:text>
    ...
    <xsl:text>    VERIFY(isSorted(scnBeg,scn,scnEnd));&#010;</xsl:text>
    ...
    <xsl:if test="count(uta:gui/*)!=0">
      ...
      <xsl:text>    VERIFY(isSorted(guiBeg,gui,guiEnd));&#010;</xsl:text>
    ...
    <xsl:text>    VERIFY(_shapes[scn].typ==shpDrawing);&#010;</xsl:text>
    ...
    <xsl:text>          break;&#010;</xsl:text>
    <xsl:text>        default:&#010;</xsl:text>
    <xsl:text>          VERIFY(mod=='h'); //fatal error&#010;</xsl:text>
    <xsl:text>          break;&#010;</xsl:text>
    <xsl:text>     }&#010;</xsl:text>
    <xsl:text>}&#010;</xsl:text>
    <xsl:text>&#010;</xsl:text>
