..\Ttf2bdf.exe -r 100 -p 10 -l '0_255'  cour.ttf> normal.bdf
...
..\bdf2fon -c -w8 -x0 -tISO1 -fnormal.bdf -s_dNORMAL_ cour.FON
..\bdf2fon -w8 -x0 -fbold.bdf -s_dBOLD_ cour.FON
..\bdf2fon -w16 -x0 -fbig.bdf -s_dBIG_ cour.FON
: ..\bdf2fon -w16 -x0 -fpnormal.bdf -s_pNORMAL_ cour.FON
..\bdf2fon -w16 -x0 -fpnormal.bdf -s_pNORMAL_ cour.FON
..\bdf2fon -w16 -x0 -fpbold.bdf -s_pBOLD_ cour.FON
..\bdf2fon -w16 -x0 -fphigh.bdf -s_pHIGH_ cour.FON
..\bdf2fon -w32 -x0 -fpbig.bdf -s_pBIG_ cour.FON
..\bdf2fon -w24 -x0 -fpmedium.bdf -s_pMEDIUM_ cour.FON
