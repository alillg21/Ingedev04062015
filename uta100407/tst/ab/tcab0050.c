 ...
 *
 * $HeadURL: https://svn.ingenico.com/UTA/core/utaYYMMDD/tst/ab/tcab0050.c $
 *
 * $Id: tcab0050.c 2534 2010-01-06 10:35:08Z abarantsev $
 */
...
void tcab0050(void) {
    ...
    ret = testGetDateTime(dateTime);
    CHECK(ret >= 0, lblKO);

    ret = testSetDateTime(dateTime);
    CHECK(ret >= 0, lblKO);
