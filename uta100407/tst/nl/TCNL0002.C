...
//Integration test case tcab0038.
//Parsing response.
...
static int prepare01(tBuffer * rsp) {
    ...
    CHK;                        //Block No
    ret = bufApp(rsp, (byte *) "3830303030303031", 0);
    CHK;                        //TermianlID
...
static int prepare02(tBuffer * rsp) {
    ...
    ret = bufApp(rsp, (byte *) "34303031343837202020", 0);
    CHK;                        //host 1 Primary Tel
    ret = bufApp(rsp, (byte *) "34303031343837202020", 0);
    CHK;                        //host 1 Alt Tel
    ret = bufApp(rsp, (byte *) "3430", 0);
    CHK;                        //host 2 Primary Tel
    return bufLen(rsp);
...
static int prepare03(tBuffer * rsp) {
    ...
    CHK;                        //Block No
    ret = bufApp(rsp, (byte *) "3339333731202020", 0);
    CHK;                        //host 2 Primary Tel
    ret = bufApp(rsp, (byte *) "34303031343837202020", 0);
    CHK;                        //host 2 Alt Tel
    ret = bufApp(rsp, (byte *) "35373339333734202020", 0);
    ...
    ret = bufApp(rsp, (byte *) "34303031343837202020", 0);
    CHK;                        //host 6 Alt Tel
    //ret= bufApp(rsp,(byte *)"34303031343837202020",0); CHK; //MDC Primary Tel 
    //ret= bufApp(rsp,(byte *)"34303031343837202020",0); CHK; //MDC Sec  Tel 
    ret = bufApp(rsp, (byte *) "35373234393031202020", 0);
    CHK;                        //MDC Primary Tel 
    ret = bufApp(rsp, (byte *) "35373234393031202020", 0);
    CHK;                        //MDC Sec  Tel 

    ret = bufApp(rsp, (byte *) "3537", 0);
    CHK;                        //Alt MDC Primary Part1 
...
static int prepare04(tBuffer * rsp) {
    ...
    CHK;                        //Block No
    ret = bufApp(rsp, (byte *) "3339333734202020", 0);
    CHK;                        //Alt MDC Pri Part2
    ret = bufApp(rsp, (byte *) "35373339333734202020", 0);
    CHK;                        //Alt MDC Sec Part2 
    ret = bufApp(rsp, (byte *) "35373339333734202020", 0);
    CHK;                        //Param Pri Tel
    ret = bufApp(rsp, (byte *) "35373339333734202020", 0);
    CHK;                        //Param Sec Tel
    ...
    ret = bufApp(rsp, (byte *) "35373339333734202020", 0);
    CHK;                        //XBul Sec Tel
    ret = bufApp(rsp, (byte *) "31303132353330302020202020202020", 0);
    CHK;                        //Referal Te
...
static int prepare05(tBuffer * rsp) {
    ...
    CHK;                        //Dl Time 
    ret = bufApp(rsp, (byte *) "31323334353637202020", 0);
    CHK;                        //DL Pri Tel
    ret = bufApp(rsp, (byte *) "31323738", 0);
    CHK;                        //Dl Sec Tel Part1
    return bufLen(rsp);
...
static int prepare06(tBuffer * rsp) {
    ...
    CHK;                        //Block No
    ret = bufApp(rsp, (byte *) "363938202020", 0);
    CHK;                        //Dl Sec Tel Part2
    ...
    ret =
        bufApp(rsp,
               ...
               0);
    CHK;                        //Reserved
    ret = bufApp(rsp, (byte *) "6808120E263703", 0);
    CHK;                        //Cur Time
    ret = bufApp(rsp, (byte *) "E6C244D70A6F3E85E6C244D70A6F3E85", 0);
    CHK;                        //PinBlock Key 
    ret = bufApp(rsp, (byte *) "68796500", 0);
    CHK;                        //Block Checksum 
    return bufLen(rsp);
...
*/
    ...
    for (j = 0; j < MAXCARDTYPE; j++) {
        ...
        CHK;
        mapMove(issBeg + 1, (word) j);
        ret = mapGetCard(issFloorLimitInd, num);
        CHK;
        num2dec(buf, num, 0);
        ret = prtS(buf);
        CHK;
