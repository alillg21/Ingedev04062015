...
/** Unitary test case for pri component: internal modem testing in V32bis.
 * \sa
 *  - comStart()
 *  - comSet()
 *  - comStop()
...
void tcas0004(void) {
    ...
    const char FillBuffer[] =
        "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.THIS MESSAGE IS SENT IN V32BIS.ENDING CHARACTER IS:]";
