/** \file 
 * Unitary test case for pri component(tcas0001.c): internal modem testing in V22 FC HDLC.
 * \sa
 *  - comStart()
 *  - comSet()
 *  - comStop()
...
//  byte b;
    ...
    const char FillBuffer[] =
        "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.THIS MESSAGE IS SENT IN V22 HDLC.ENDING CHARACTER IS:]";
     ...
     * The Data Link Layer chosen is HDLC.
     * Default init string for HDLC is T8N11200
     */
