...
/** Unitary test case for pri component: internal modem testing in V22bis.
 * \sa
 *  - comStart()
 *  - comSet()
 *  - comStop()
...
void tcas0002(void) {
    ...
    const char FillBuffer[] =
        "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.THIS MESSAGE IS SENT IN V22BIS.ENDING CHARACTER IS:]";
